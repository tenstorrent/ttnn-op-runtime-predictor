...
def create_dataset_csv(op_name, input_shape_list, dtype_list, input_mem_cfg_list, kernel_duration_list):
    ...
    with open(f"{op_name}_dataset.csv", 'w') as csv_file:
        ...
        csv_writer.writerow(['m','k','n','bfloat8','bfloat16','float32','uint16','uint32','input_DRAM','input_L1','kernel_duration'])
...
def create_dataset_matmul(op_name, sweep_test_vectors, sweep_results):
