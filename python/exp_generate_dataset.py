...
results_file = open('datasetGen/exp/exp_results.json')
test_vectors_file = open('datasetGen/exp/exp_test_vectors.json')
...
#create csv file
with open('datasetGen/exp/exp_dataset.csv', 'w') as f:
